export function EventCreatedEmailTemplate({
  name,
  eventName,
  description,
  startDate,
          ...
          <tr>
            <td style="padding: 0 40px 40px;">
              ...
              <p style="color: #5f6368; font-size: 16px; line-height: 26px; margin-bottom: 24px;">
                A new event <strong>"${eventName}"</strong> has been created for your department and branch.
              </p>

              <div style="background-color: #f1f3f4; border-left: 4px solid #4285F4; border-radius: 4px; padding: 16px 24px; margin-bottom: 24px;">
              ...
              <p style="color: #5f6368; font-size: 14px; line-height: 22px; margin-bottom: 24px;">
                Please check your event calendar or dashboard for more details.
              </p>
          ...
          <tr>
            <td style="padding: 24px 40px; border-top: 1px solid #dadce0;">
              <p style="color: #5f6368; font-size: 12px; line-height: 18px; margin: 0;">
                This email was sent to notify you of a newly scheduled event. If you have questions, please contact your HR/admin.
              </p>
            </td>
          </tr>
